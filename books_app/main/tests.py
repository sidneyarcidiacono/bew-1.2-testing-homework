...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            "name": "Dostoyevsky",
            "biography": "Russian biography stuff.",
        }
        self.app.post("/create_author", data=post_data)

        created_author = Author.query.filter_by(name="Dostoyevsky").one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, "Dostoyevsky")
        self.assertEqual(created_author.biography, "Russian biography stuff.")
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name="Philosophy").one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, "Philosophy")
